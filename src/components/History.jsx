    ...
    <section>
      ...
      <form action="/" method="post" autoComplete="off" className="border border-solid rounded-lg border-gray-900 p-4">
        <div className="my-2">
          ...
          <input type="text" name="education" id="education" className="bg-gray-100 rounded-lg border-none w-full" />
        </div>
        ...
        <div className="my-2">
          ...
          <input type="text" name="school" id="school" className="bg-gray-100 rounded-lg border-none w-full" />
        </div>

        <div className="flex gap-2 my-2">
          <div className="flex-1">
            <label htmlFor="start-date" className="block font-medium text-gray-700">
              Start Date
            </label>
            <input
              type="date"
          ...
          <div className="flex-1 my-2">
            ...
            <input type="date" name="end-date" id="end-date" className="bg-gray-100 rounded-lg border-none w-full" />
          </div>
        </div>
